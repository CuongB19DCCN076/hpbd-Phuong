...
$('document').ready(function(){
	...
	function loop11() {
		var randleft = 1000*Math.random();
		var randtop = 500*Math.random();
		$('#b11').animate({right:randleft,bottom:randtop},10000,function(){
			loop11();
		});
	}
	function loop12() {
	...
	$('#balloons_flying').click(function(){
		...
		$('#b8,#b11,#b12,#b14').addClass('balloons-rotate-behaviour-one');
		$('#b9,#b10,#b13').addClass('balloons-rotate-behaviour-two');
	...
	$('#wish_message').click(function(){
		...
		$('#b1,#b2,#b3,#b4,#b5,#b6,#b7').stop();
		$('#b8,#b9,#b10,#b11,#b12,#b13,#b14').hide();
		$('#b1').attr('id','b11');
		$('#b2').attr('id','b22')
		$('#b3').attr('id','b33')
		$('#b4').attr('id','b44')
